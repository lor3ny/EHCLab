...
#include <string.h>
#include <stdlib.h>
//JMPC #include <unistd.h>
#include <assert.h>
#include <time.h>
//JMPC #include <sys/time.h>
//JMPC #include <sys/resource.h>
//JMPC #include <sched.h>
#include <math.h>
#ifdef _OPENMP
# include <omp.h>
#endif
...
xmalloc(size_t num)
{
	void* new1 = NULL; // JMPC new -> new1
	int ret = posix_memalign(&new1, 32, num);
	new1 = _aligned_malloc(num, 32);
	if (!new1)
	{
