...
gcc -pg -Wall -D K=20 -D NUM_TRAINING_SAMPLES=40002 -D NUM_TESTING_SAMPLES=9998 -D NUM_FEATURES=100 -D NUM_CLASSES=8 -std=gnu99 -lm -O3 -fopenmp -c src/knn_omp_quick.c -o build/knn_omp_quick.o
gcc -pg -Wall -D K=20 -D NUM_TRAINING_SAMPLES=40002 -D NUM_TESTING_SAMPLES=9998 -D NUM_FEATURES=100 -D NUM_CLASSES=8 -std=gnu99 -lm -O3 -fopenmp src/main.c build/utils.o build/timer.o build/knn_omp_quick.o build/io.o -o build/knn_omp_quick
