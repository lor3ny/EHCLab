...
nvcc -D CUDA_VERSION=2 -D K=20 -D DT=2 -D NUM_TRAINING_SAMPLES=40002 -D NUM_TESTING_SAMPLES=9998 -D NUM_FEATURES=100 -D NUM_CLASSES=8 -O3 -c src/knn_cuda_quicksort.cu -o build/knn_cuda_quicksort_v2.obj
nvcc -D CUDA_VERSION=2 -D K=20 -D DT=2 -D NUM_TRAINING_SAMPLES=40002 -D NUM_TESTING_SAMPLES=9998 -D NUM_FEATURES=100 -D NUM_CLASSES=8 -O3 src/main.c build/knn_cuda_quicksort_v2.obj build/utils.obj build/timer.obj build/io.obj -o build/knn_cuda_quicksort_v2
